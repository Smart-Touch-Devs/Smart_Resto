                            ...
                            <div class="card-body">
                                ...
                                <form class="auth-forgot-password-form mt-2" action="#" method="POST">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="forgot-password-email" name="forgot-password-email" placeholder="example@gmail.com" aria-describedby="forgot-password-email" tabindex="1" autofocus />
                                    </div>
                                    <button class="btn btn-primary w-100" tabindex="2">Envoyer</button>
                                </form>

                                <p class="text-center mt-2">
                                    <a href="{{ route('restaurant.login') }}"> <i data-feather="chevron-left"></i>Page de connexion</a>
                                </p>
                            </div>
                        </div>
                        <!-- /Forgot Password basic -->
