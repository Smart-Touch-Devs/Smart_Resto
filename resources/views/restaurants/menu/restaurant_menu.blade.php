                            ...
                            <form action="{{ route('menu.store') }}" method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <select class="selectpicker" name="dishId[]" multiple data-live-search="false">
                                            ...
                                            <div style="width: 20%; height: fit-content;"
                                                ...
                                                <div class="bg-light border-bottom d-flex justify-content-around align-items-center"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="modal fade text-start" id="edit_menu_{{ $menu->day->name }}" tabindex="-1"
                                                            aria-labelledby="myModalLabel33" aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title" id="myModalLabel33">
                                                                            Editer le menu du {{ $menu->day->name }}</h4>
                                                                    ...
                                                                    <form action="{{ route('menu.update', $menu->id) }}"
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="mb-1">
                                                                                <h3>Liste des plats actuels du menu</h3>
                                                                                <ul>
                                                                            ...
                                                                            <div class="mb-1">
                                                                                <label class="form-label">Sélection de
                                                                                    plats</label> <br>
                                                                                <select
                                                                                    name="dishesId[]" multiple class="form-control">
                                                                                    @foreach(Auth::user()->custom->dishes
                                                                                    as $dish)
                                                                                    <option value="{{ $dish->id }}" @if (in_array($dish, $menu->custom))
                                                                                        selected
                                                                                    @endif>{{
                                                                                        $dish->name }}</option>
                                                                                    @endforeach
